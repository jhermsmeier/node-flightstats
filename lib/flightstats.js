...
/**
 * @constructor
 * @param {FlightStats~ConstructorOptions} options
 * @return {FlightStats}
 */
...
/**
 * Available options for {@link FlightStats}
 * @typedef {Object} FlightStats~ConstructorOptions
 * @property {?String} [baseUrl='https://api.flightstats.com/flex'] optional
...
FlightStats.prototype = {
  ...
  /**
   * Available options for [.getAirlines()]{@link FlightStats#getAirlines}
   * @typedef {Object} FlightStats~AirlineOptions
   * @property {Boolean} [all=false] optional
   * @property {?Date} [date] optional
   * @property {?String} [iata] optional
   * @property {?String} [icao] optional
   * @property {?String} [fs] optional
   */

  /**
   * Retrieve a list of airlines
   * @param {FlightStats~AirlineOptions} options
  ...
  /**
   * Available options for [.getAirports()]{@link FlightStats#getAirports}
   * @typedef {Object} FlightStats~AirportOptions
   * @property {?Boolean} [all=false] optional
   * @property {?Date} [date] optional
   * @property {?String} [iata] optional
   * @property {?String} [icao] optional
   ...
   * @property {?Number} [latitude] optional
   * @property {?Number} [longitude] optional
   * @property {?Number} [radius] optional
   */

  /**
   * Retrieve a list of airports
   * @param {FlightStats~AirportOptions} options
   * @param {Function} callback
   * @return {Request}
   */
  ...
  /**
   * Available options for [.lookup()]{@link FlightStats#lookup},
   * [.schedule()]{@link FlightStats#schedule} and [.status()]{@link FlightStats#status}
   * @typedef {Object} FlightStats~LookupOptions
   * @property {Date} date
   * @property {String} airlineCode
   * @property {String} flightNumber
   * @property {?String} [airport] optional
   * @property {?String} [direction='arr'] optional
   * @property {?Array<String>} [extendedOptions] optional
   */

  /**
   * Look up a flight
   * @param {FlightStats~LookupOptions} options
   * @param {Function} callback
   * @return {Request}
   */
  ...
  /**
   * Available options for [.firstFlightIn()]{@link FlightStats#firstFlightIn},
   * [.firstFlightOut()]{@link FlightStats#firstFlightOut},
   * [.lastFlightIn()]{@link FlightStats#lastFlightIn},
   * [.lastFlightOut()]{@link FlightStats#lastFlightOut},
   * [.connections()]{@link FlightStats#connections}
   * @typedef {Object} FlightStats~ConnectionOptions
   * @property {?String} [type] optional, only used by `.connections()`
   * @property {String} departureAirport
   * @property {String} arrivalAirport
   * @property {Date} date
   * @property {?Number} [numHours=6] optional
   * @property {?Number} [maxResults=25] optional
   * @property {?Number} [maxConnections=2] optional
   * @property {?Number} [minimumConnectTime] optional
   * @property {?String} [payloadType='passenger'] optional
   * @property {?Array<String>} [includeAirlines] optional
   * @property {?Array<String>} [excludeAirlines] optional
   * @property {?Array<String>} [includeAirports] optional
   * @property {?Array<String>} [excludeAirports] optional
   * @property {?Boolean} [includeSurface=false] optional
   * @property {?Boolean} [includeCodeshares=true] optional
   * @property {?Boolean} [includeMultipleCarriers=true] optional
   */

  /**
   * Get the first inbound flight between two airports
   * @param {FlightStats~ConnectionOptions} options
   * @param {Function} callback
   * @return {Request}
   */
