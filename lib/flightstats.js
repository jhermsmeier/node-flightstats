...
FlightStats.prototype = {
   ...
   * @property {String} [direction='arr']
   * @property {Array<String>} [extendedOptions]
   */
   ...
   * @property {Date}   date
   * @property {Number} [numHours=6]
   * @property {Number} [maxResults=25]
   * @property {Number} [maxConnections=2]
   * @property {Number} [minimumConnectTime]
   * @property {String} [payloadType='passenger']
   * @property {Array<String>} [includeAirlines]
   * @property {Array<String>} [excludeAirlines]
   * @property {Array<String>} [includeAirports]
   * @property {Array<String>} [excludeAirports]
   * @property {Boolean} [includeSurface=false]
   * @property {Boolean} [includeCodeshares=true]
   * @property {Boolean} [includeMultipleCarriers=true]
   */
