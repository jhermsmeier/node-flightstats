...
function formatStatusUpdate( data ) {
  ...
  var updates = data.updatedTextFields ? data.updatedTextFields.concat(data.updatedDateFields || []) : data.updatedDateFields
  ...
  if( updates ) {
    ...
    updates.forEach( function( data ) {
      ...
      event.changes.push({
        ...
        originalValue: data.originalText || data.originalDateLocal,
        value: data.newText || data.newDateLocal,
      })
